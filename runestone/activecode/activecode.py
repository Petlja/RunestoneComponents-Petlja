...
def setup(app):
    ...
    app.add_css_file('activecode.css')
    
    app.add_js_file('jquery.highlight.js')
    ...
    #add_skulpt_js(app)
    app.add_js_file('activecode.js')
    app.add_js_file('clike.js')
    app.add_js_file('timed_activecode.js')
